...
public class LoaderPlugin implements Plugin<Project> {
    ...
    void configurations(@NotNull Project project) {
        ...
        configurations.register("commonGenerated", files -> files.setCanBeResolved(true));
    }
    ...
    void dependencies(@NotNull Project project) {
        ...
        dependencies.add("commonGenerated", dependencies.project(Map.of("path", ":common", "configuration", "commonGenerated")));
    ...
    void tasks(@NotNull Project project) {
        ...
        tasks.named("processResources", ProcessResources.class).configure(it -> {
            ...
            it.dependsOn(project.getConfigurations().named("commonGenerated"));
            it.from(project.getConfigurations().named("commonGenerated"));
            it.exclude("**/*.bbmodel");
            it.exclude("**/*.psd");
            it.exclude("src/generated/**/.cache");
        });
