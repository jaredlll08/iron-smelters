...
public class CommonPlugin implements Plugin<Project> {
    ...
    void dependencies(@NotNull Project project) {
        ...
        dependencies.add("implementation", "com.google.auto.service:auto-service-annotations:1.1.1");
        dependencies.add("annotationProcessor", "com.google.auto.service:auto-service:1.1.1");
    }
    ...
    void repositories(@NotNull Project project) {
        ...
        repositories.maven(maven -> {
            ...
            maven.content(content -> {
                ...
                content.includeGroup("net.darkhax.pricklemc");
            });
        });
        repositories.maven(maven -> {
